...
const consentLabels: ReactElement[] = [
  ...
  <span key="2">
    ...
    is not ideally accurate, but nevertheless I make the specified decision on my
    own and I take the risk that the specified will can be executed if I am not{" "}
    <em>dead</em> (for example, if I am unconscious, or I am in prison, or I
    lost my phone, or for some other reason I do not have access to communication).
  </span>,
  <span key="3">
    I understand that using the Application does not replace notarial certification
    of my last will and other procedures established by the law of my country for
    the official transfer of property and inheritance rights.
  </span>,
  <span key="4">
    I certify that the specified workflow was created and verified by me, it does
    not carry out illegal actions, does not violate the rights of third parties,
    is not capable of harming me and other people and organizations, does not
    violate the laws of my country and the Federal Republic of Germany.
  </span>,
];
  ...
  return (
    <>
      ...
      <Paper sx={{ p: 2, mt: 3, mb: 2, textAlign: "left" }}>
        <Typography>
          I do authorize the Application to fulfill my last will by executing the
          workflow <strong>{workflow}</strong> located in the private repository{" "}
          <strong>{repo}</strong> on GitHub in case of my <em>death</em>.
        </Typography>
