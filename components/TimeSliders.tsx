...
export function TimeSliders({
  ...
  const initialIndex = (Object.keys(checkFreqLabels) as CheckFreqCode[]).indexOf(initialCheckFreqCode);
  ...
  return (
    <Box sx={[!isXS && { minWidth: "300px" }, isXS && { ml: 1, mr: 1 }]}>
      <Typography>
        ...
        <strong>{Object.values(checkFreqLabels)[checkFreqIndex]}</strong>
        <Tooltip
          arrow
