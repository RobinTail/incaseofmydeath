...
import { z } from "zod";
import { publicUserByIdFactory, publicUserByLoginFactory } from "../factories";

export const [getPublicStatusByIdEndpoint, getPublicStatusByLoginEndpoint] = [
  publicUserByIdFactory,
  publicUserByLoginFactory,
].map((factory) =>
  factory.build({
    method: "get",
    input: z.object({}),
